...
import { Image, StyleSheet, ScrollView, Text, View, SafeAreaView, FlatList, TouchableOpacity, useWindowDimensions, Picker } from 'react-native';
  ...
  const renderItem = ({ item }) => (
      <TouchableOpacity style = {styles.orderCard}>
        ...
        <View style ={styles.orderCardContent}>
            ...
            <Button mode="contained" labelStyle = {10 }>
                Cancelar
            </Button>
        </View>
        </TouchableOpacity>
